    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                ...
                <br></br>
                <br></br>
                <h1>CATEGORY INFO:</h1><br>
                <ul>
                    <li><a href="post.php">APAKAH YANG DIMAKSUD CODING ITU?</a></li>
                    <li><a href="post4.php">JENIS-JENIS ERROR SAAT CODING</a></li>
                </ul>
            </div>
        </div>
    </div>
