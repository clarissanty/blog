        ...
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                <div class="post-preview">
                    <a href="post5.php">
                        <h2 class="post-title">
                            Cara Membuat Database Dan Table Mysql Di PHP Myadmin XAMPP
                        </h2>
                        <h3 class="post-subtitle">
                            Halo Sobat Coding, kali ini saya akan membahas Cara Membuat Database dan Tabel MySQL di PhpMyadmin Xampp. Berikut langkah-langkahnya : 
                        </h3>
                    </a>
                    <p class="post-meta">Posted by <a href="#">SHANTY</a> pada 03 MEI 2017</p>
                </div>
                <!-- Pager -->
