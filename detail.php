...
<body>
    ...
    <header class="intro-header" style="background-image: url('img/1.jpg')">
        <div class="container">
        	<input type="hidden" name="" value="<?php $r->id_post; ?>" name="id_post"></input>
        </div>
    </header>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                    <p><br><b><?php echo $r['title_post']; ?></b></br></p>
                    <article><p><?php echo $r['content']; ?></p></article>
                    <p> Di posting pada : <?php echo $r['created_at']; ?></p>
                </div>
            </div>
            <br></br>
