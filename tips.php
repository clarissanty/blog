    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                ...
                <br></br>
                <br></br>
                <h1>CATEGORY TIPS:</h1><br>
                <ul>
                    <li><a href="post2.php">APAKAH ANDA INGIN MENJADI PROGRAMMER?</a></li>
                    <li><a href="post3.php">CARA SANTAI BELAJAR PEMROGRAMAN</a></li>
                </ul>
            </div>
        </div>
    </div>
